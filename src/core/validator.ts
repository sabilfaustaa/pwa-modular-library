...
export function validateConfig(config: unknown): PWAConfig {
  ...
  if (cfg.serviceWorker !== undefined) {
    ...
    if (
      ...
      throw new ConfigValidationError("serviceWorker.updateViaCache must be one of: all, imports, none");
    }
  }
  ...
  if (cfg.cache !== undefined) {
    ...
    if (cfg.cache.defaultCacheName !== undefined && typeof cfg.cache.defaultCacheName !== "string") {
  ...
  if (cfg.storage !== undefined) {
    ...
    if (cfg.storage.storeName !== undefined && typeof cfg.storage.storeName !== "string") {
  ...
  if (cfg.notification !== undefined) {
    ...
    if (
      ...
      throw new ConfigValidationError("notification.requestPermissionOnInit must be a boolean");
    }
  }
